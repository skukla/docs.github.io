...
**Data Packs** are collections of **data files** and **media files** which can be used to create sample data for Adobe Commerce.
...
Since data packs are made up largely of `.json` files, let's dive into a brief primer on what JSON is and how it works.